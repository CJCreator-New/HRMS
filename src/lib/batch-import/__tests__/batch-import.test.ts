...
describe("Batch Import Utilities", () => {
  ...
  describe("Template Generation", () => {
    ...
    it("generates valid XLSX workbook buffer", () => {
      const buffer = generateXlsxTemplate(StatutoryProfileBatchSchema);
  ...
  describe("Parser & Validator", () => {
    it("parses valid CSV string and produces valid report", () => {
      ...
      const report = parseAndValidateBatchFile(csv, SalaryStructureBatchSchema);
    ...
    it("flags invalid row with missing required fields or bad format", () => {
      ...
      const report = parseAndValidateBatchFile(csv, StatutoryProfileBatchSchema);
    ...
    it("detects date range anomalies and internal duplicates in salary schema", () => {
