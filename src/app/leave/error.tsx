  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="bg-surface rounded-xl border border-line shadow-card max-w-md w-full p-6 text-center space-y-3">
        ...
        <h2 className="text-lg font-bold text-ink">Leave Engine Error</h2>
        <p className="text-xs text-ink-secondary">
          Unable to load leave balances and applications
          {error?.digest ? ` (${error.digest})` : ""}. Your leave data has not
          been affected.
        </p>
