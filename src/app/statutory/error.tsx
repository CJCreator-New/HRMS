...
export default function StatutoryError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-6">
      <div className="bg-surface rounded-xl border border-line shadow-card max-w-md w-full p-6 text-center space-y-3">
        ...
        <h2 className="text-lg font-bold text-ink">Statutory Compliance Failed</h2>
        <p className="text-xs text-ink-secondary">
          An error occurred while loading PF, ESI, or PT statutory rule profiles
        ...
        <div className="flex items-center justify-center gap-2 pt-2">
          ...
          >
            <RefreshCw className="w-3.5 h-3.5" /> Retry Statutory
          </button>
          <Link
            href="/dashboard"
